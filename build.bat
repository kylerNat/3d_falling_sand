...
set INCLUDES=-I "%HOME%/lib/" -I "%HOME%/lib/imgui/" -I "%HOME%/lib/imgui/backends/" -I "%HOME%/lib/tracy/public/" -I "%HOME%/lib/sdl/include/"
...
set LIBS= -lUser32.lib -lGdi32.lib -lopengl32.lib -lOle32.lib
