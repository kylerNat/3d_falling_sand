...
clang -ftime-trace -Wno-deprecated-declarations -Wno-braced-scalar-init -Wno-c++11-narrowing -Wno-writable-strings -g -gcodeview -O0 -mavx -mavx2 -mmmx -msse -msse2 -msse3 -mssse3 -msse4.1 -msse4.2 -o "3dsand.exe" -D DEBUG -I "C:/Users/Kyler/lib/" "../code/win32_gl_main.cpp" -lUser32.lib -lGdi32.lib -lopengl32.lib -lOle32.lib
